...
@testset "MeshTest.jl" begin
    ...
    @test mesh.tag.cut_cells == Tuple{CartesianIndex, Int64}[(CartesianIndex(4, 1), 4), (CartesianIndex(5, 1), 5), (CartesianIndex(6, 1), 6), (CartesianIndex(4, 2), 15), (CartesianIndex(6, 2), 17), (CartesianIndex(4, 3), 26), (CartesianIndex(5, 3), 27), (CartesianIndex(6, 3), 28)]
