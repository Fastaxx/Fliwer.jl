...
"""
struct AutoBody{F<:Function,G<:Function} <: AbstractBody
    sdf::F
    map::G
...
Base.:∪(a::AutoBody, b::AutoBody) = a + b
Base.:-(a::AutoBody) = AutoBody((x,t)->a.sdf(x,t),a.map,compose=false)
Base.:-(a::AutoBody, b::AutoBody) = a ∩ (-b)
